    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/your-username/physical-ai-humanoid-robotics/tree/main/docs/',
        },
            ...
            items: [
              {
                ...
                to: '/docs/modules/ros2-fundamentals',
              },
              {
                label: 'Simulation Environments',
                to: '/docs/modules/simulation-environments',
              },
              {
                label: 'AI Perception & Navigation',
                to: '/docs/modules/ai-perception',
              },
              {
